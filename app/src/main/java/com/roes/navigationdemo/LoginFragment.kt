...
import com.roes.navigationdemo.databinding.FragmentLoginBinding
...
class LoginFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.btnLogin.setOnClickListener(){
            ...
            val inputPassWord: String = binding.tvPass.text.toString()

            if (inputUserName == "TNR" && inputPassWord == "tnr"){
